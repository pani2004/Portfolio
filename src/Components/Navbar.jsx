...
const Navbar = () =>{
    ...
    fixed bg-black px-4'>
      <div>
        <h1 className='text-5xl font-signature ml-2'>Debashis</h1>
      </div>
      <ul className='hidden md:flex'>
        {links.map(({id,link})=>(
          <li key={link.id} className='px-4 cursor-pointer font-medium text-gray-500 hover:scale-105 duration-200'>
